...
public class HomePageSelectors
{
	...
	// adding this
	public static final cselector countrySelectorBD = new cselector("css,#gwt_country_changer");
	// adding this
	public static final cselector countrySelectorBDforMobile = new cselector("css,#app-footer > footer > div.u-bg-color-neutral-00.u-margin-top-lg.u-margin-bottom-lg.u-padding-start-lg.u-padding-end-lg > div > button");
	// adding this
	public static final cselector accordionHeaderBD =  new cselector("css,#footer > div.line2 > div.footerLinks > div.section.footer-links-list > div:nth-child(1) > div.header");
	...
	// adding this
	public static final cselector accordionHeaderBDforMobile =  new cselector("css,#app-footer > footer > div.c-custom-accordion.u-margin-start-lg.u-margin-end-lg > div");
	// adding this
	public static final cselector globalFooterBD = new cselector("css,#footer > div.line2 > div.footerLinks > div.section.footer-links-list");
	public static final cselector globalFooter =  new cselector("css,div.footerInner","css,footer > div.c-custom-accordion"); 
	// adding this
	public static final cselector globalFooterBDforMobile = new cselector("css,#app-footer > footer > div.t-footer__phone.u-margin-bottom-lg.u-text-size-medium.u-flex-none");
	...
	//adding this
	public static final cselector espotsforMobileBD = new cselector("css,#module1 > div:nth-child(2) > div > a > img");
