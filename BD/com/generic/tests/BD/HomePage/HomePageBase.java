...
public class HomePageBase extends SelTestCase {
	...
	public static final String CountrySelector = "Country Selector Validation";
	//public static final String AccordionHeader = "Accordion Header";
	...
	public void HomePageRegressionTest(String caseId, String runTest, String desc, String proprties) throws Exception {
		...
		try {
			...
			else if (proprties.contains(CountrySelector)) {
				HomePage.validateCountrySelectorDisplayed();
			}
		/*	else if (proprties.contains(AccordionHeader)) {
				HomePage.validateGlobalFooterItemsDisplayed();
			}*/
			else if (proprties.equals(menu)) {
				// Check the Navigation menu.
				sassert().assertTrue(MenuValidation.validate(), "Menu validation has some problems");
